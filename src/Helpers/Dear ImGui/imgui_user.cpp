...
#pragma endregion
  ...
  IMGUI_API void LoadStyle() {
    ...
    style.Colors[ImGuiCol_FrameBgHovered]        = ImVec4(0.70f, 0.28f, 0.00f, 0.40f);
    style.Colors[ImGuiCol_FrameBgActive]         = ImVec4(0.80f, 0.32f, 0.00f, 0.40f);
    style.Colors[ImGuiCol_TitleBg]               = ImVec4(0.80f, 0.34f, 0.03f, 0.80f);
    style.Colors[ImGuiCol_TitleBgActive]         = ImVec4(0.89f, 0.37f, 0.03f, 0.80f);
    ...
    style.Colors[ImGuiCol_CheckMark]             = ImVec4(0.89f, 0.37f, 0.03f, 1.00f);
    style.Colors[ImGuiCol_SliderGrab]            = ImVec4(0.80f, 0.33f, 0.02f, 1.00f);
    style.Colors[ImGuiCol_SliderGrabActive]      = ImVec4(0.89f, 0.37f, 0.03f, 1.00f);
    style.Colors[ImGuiCol_Button]                = ImVec4(0.80f, 0.33f, 0.02f, 1.00f);
    style.Colors[ImGuiCol_ButtonHovered]         = ImVec4(1.00f, 0.42f, 0.04f, 1.00f);
    style.Colors[ImGuiCol_ButtonActive]          = ImVec4(0.89f, 0.37f, 0.03f, 1.00f);
    style.Colors[ImGuiCol_Header]                = ImVec4(1.00f, 0.40f, 0.00f, 1.00f);
    style.Colors[ImGuiCol_HeaderHovered]         = ImVec4(1.00f, 0.40f, 0.00f, 1.00f);
    style.Colors[ImGuiCol_HeaderActive]          = ImVec4(1.00f, 0.40f, 0.00f, 1.00f);
    ...
    style.Colors[ImGuiCol_ResizeGrip]            = ImVec4(0.80f, 0.32f, 0.00f, 0.40f);
    style.Colors[ImGuiCol_ResizeGripHovered]     = ImVec4(0.90f, 0.36f, 0.00f, 0.80f);
    style.Colors[ImGuiCol_ResizeGripActive]      = ImVec4(1.00f, 0.40f, 0.00f, 1.00f);
    style.Colors[ImGuiCol_Tab]                   = ImVec4(0.89f, 0.37f, 0.03f, 0.50f);
    style.Colors[ImGuiCol_TabHovered]            = ImVec4(1.00f, 0.42f, 0.04f, 1.00f);
    style.Colors[ImGuiCol_TabActive]             = ImVec4(0.89f, 0.37f, 0.03f, 1.00f);
    style.Colors[ImGuiCol_TabUnfocused]          = ImVec4(0.00f, 0.00f, 0.00f, 0.00f);
    style.Colors[ImGuiCol_TabUnfocusedActive]    = ImVec4(0.89f, 0.37f, 0.03f, 1.00f);
    style.Colors[ImGuiCol_PlotLines]             = ImVec4(0.61f, 0.61f, 0.61f, 1.00f);
    style.Colors[ImGuiCol_PlotLinesHovered]      = ImVec4(1.00f, 0.61f, 0.35f, 1.00f);
    style.Colors[ImGuiCol_PlotHistogram]         = ImVec4(0.90f, 0.36f, 0.00f, 1.00f);
    style.Colors[ImGuiCol_PlotHistogramHovered]  = ImVec4(1.00f, 0.40f, 0.00f, 1.00f);
    style.Colors[ImGuiCol_TableHeaderBg]         = ImVec4(0.19f, 0.19f, 0.20f, 1.00f);
    style.Colors[ImGuiCol_TableBorderStrong]     = ImVec4(0.31f, 0.31f, 0.35f, 1.00f);
    style.Colors[ImGuiCol_TableBorderLight]      = ImVec4(0.23f, 0.23f, 0.25f, 1.00f);
    style.Colors[ImGuiCol_TableRowBg]            = ImVec4(0.00f, 0.00f, 0.00f, 0.00f);
    style.Colors[ImGuiCol_TableRowBgAlt]         = ImVec4(1.00f, 1.00f, 1.00f, 0.06f);
    style.Colors[ImGuiCol_TextSelectedBg]        = ImVec4(0.85f, 0.34f, 0.00f, 0.40f);
